const CACHE='iching-pwa-v1.0.16-accent-exp2';
const OFFLINE_URL='./index.html';
const ASSETS=[
  './','./index.html','./css/styles.css','./css/library.css','./manifest.webmanifest','./icons/icon.svg',
  './js/app.js','./js/version.js','./js/history-clear.js','./js/reading-ui.js','./js/guide-ui.js','./js/library-guide-ui.js','./js/library.js','./js/install.js','./js/random.js','./js/storage.js','./js/ui.js','./js/interpretation.js','./js/preferences.js',
  './data/hexagrams.js','./data/profiles.js','./data/transitions.js','./data/classical-sources.js','./data/structural-context.js','./data/line-accent-selector.js','./data/hexagram-guides-01-10.js','./data/hexagram-guides-11-16.js','./data/hexagram-guides-17-24.js','./data/hexagram-guides-25-32.js','./data/hexagram-guides-33-40.js','./data/hexagram-guides-41-48.js','./data/hexagram-guides-49-56.js','./data/hexagram-guides-57-64.js',
