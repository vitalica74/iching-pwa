const CACHE='iching-pwa-v1.0.1';
const OFFLINE_URL='./index.html';
const ASSETS=[
  './','./index.html','./css/styles.css','./css/library.css','./manifest.webmanifest','./icons/icon.svg',
  './js/app.js','./js/reading-ui.js','./js/guide-ui.js','./js/library.js','./js/install.js','./js/random.js','./js/storage.js','./js/ui.js','./js/interpretation.js','./js/preferences.js',
